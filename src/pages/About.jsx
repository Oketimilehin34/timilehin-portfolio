...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 animate-in fade-in duration-1000">
      ...
      {/* Change 1: Added 'flex flex-col' for mobile and 'md:grid' for desktop */}
<div className="flex flex-col md:grid md:grid-cols-[1.5fr_2fr] gap-12 items-start">
  
  {/* Profile Sidebar */}
  {/* Change 2: Removed 'sticky' on mobile by using 'md:sticky' */}
  <div className="w-full space-y-6 md:sticky md:top-24">
    <div className="relative group">
      ...
      {/* Change 3: Constrain image height on mobile so it doesn't push text too far down */}
      <div className="relative aspect-[4/5] max-h-[400px] md:max-h-none overflow-hidden rounded-2xl border border-slate-700 bg-slate-800">
        <img 
          src={profileImg} 
          ...
          <section>
            ...
            <div className="border-l border-slate-800 space-y-8 ml-2">
              ...
              <div className="relative pl-8">
                ...
                <h4 className="text-slate-500 font-mono text-[10px] uppercase tracking-widest font-bold">2023 - 2026</h4>
